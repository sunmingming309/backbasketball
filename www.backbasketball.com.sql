/*
 ...
 Source Schema         : www.backbasketball.com

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 16/04/2020 17:53:52
*/
...
-- Records of fa_admin
-- ----------------------------
INSERT INTO `fa_admin` VALUES (1, 'admin', 'Admin', 'a175d80a3b287295c525dacd7f448e24', '7ae564', '/assets/img/avatar.png', 'admin@admin.com', 0, 1587028414, '127.0.0.1', 1492186163, 1587028414, '526ecd0f-cd7e-4ab3-97e5-d430890bcc01', 'normal');
...
-- ----------------------------
INSERT INTO `fa_admin_log` VALUES (1, 1, 'admin', '/YyiTWpmKNe.php/index/login?url=%2FYyiTWpmKNe.php', '登录', '{\"url\":\"\\/YyiTWpmKNe.php\",\"__token__\":\"a5ec2c36dc922d634f92a03276884013\",\"username\":\"admin\",\"captcha\":\"tb7n\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', 1587028414);
INSERT INTO `fa_admin_log` VALUES (2, 1, 'admin', '/YyiTWpmKNe.php/ajax/upload', '', '{\"name\":\"\\u5fae\\u4fe1\\u622a\\u56fe_20200416173632.png\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', 1587029798);
INSERT INTO `fa_admin_log` VALUES (3, 1, 'admin', '/YyiTWpmKNe.php/ajax/upload', '', '{\"name\":\"\\u5fae\\u4fe1\\u622a\\u56fe_20200416173632.png\"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36', 1587029805);
...
INSERT INTO `fa_attachment` VALUES (2, 1, 0, '/uploads/20200416/1d3d6e12ac8efc94f8d9aef7f2e2c8bb.png', '482', '422', 'png', 0, 261193, 'image/png', '{\"name\":\"\\u5fae\\u4fe1\\u622a\\u56fe_20200416173632.png\"}', 1587029798, 1587029798, 1587029798, 'local', 'c69af891dda3939634e8ab15b7c1d65d389db23d');
...
-- ----------------------------
INSERT INTO `fa_config` VALUES (1, 'name', 'basic', 'Site name', '请填写站点名称', 'string', '篮球梦', '', 'required', '');
