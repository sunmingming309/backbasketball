<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\phpstudy_pro\WWW\backbasketball\public/../application/admin\view\store\edit.html";i:1587107072;s:77:"D:\phpstudy_pro\WWW\backbasketball\application\admin\view\layout\default.html";i:1583049508;s:74:"D:\phpstudy_pro\WWW\backbasketball\application\admin\view\common\meta.html";i:1583049508;s:76:"D:\phpstudy_pro\WWW\backbasketball\application\admin\view\common\script.html";i:1583049508;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input data-field="user_name" id="c-member_id" data-rule="required" data-source="member/index" class="form-control selectpage" name="row[member_id]" type="text" value="<?php echo htmlentities($row['member_id']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Store_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-store_name" class="form-control" name="row[store_name]" type="text" value="<?php echo htmlentities($row['store_name']); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-storeavatar" class="form-control" size="50" name="row[storeavatar]" type="text" value="<?php echo htmlentities($row['storeavatar']); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-store_bannerimages" class="form-control" size="50" name="row[store_bannerimages]" type="text" value="<?php echo htmlentities($row['store_bannerimages']); ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-store_introduction" class="form-control " rows="5" name="row[store_introduction]" cols="50"><?php echo htmlentities($row['store_introduction']); ?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Store_phone'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-store_phone" class="form-control" name="row[store_phone]" type="text" value="<?php echo htmlentities($row['store_phone']); ?>">
        </div>
    </div>
